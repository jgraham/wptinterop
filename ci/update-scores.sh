...
uv run --project python interop-score --repo-root repos --log-level debug --wpt-fyi https://interop-2025-mock-dot-wptdashboard-staging.uk.r.appspot.com/interop-2025 --repo-root repos
